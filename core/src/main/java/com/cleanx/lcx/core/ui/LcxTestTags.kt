...
object LcxTestTags {
    ...
    const val INCIDENTS_NEW_ROOT = "incidents-new-root"
    const val INCIDENTS_HISTORY_ROOT = "incidents-history-root"
    const val DAMAGED_CLOTHING_NEW_ROOT = "damaged-clothing-new-root"
    const val DAMAGED_CLOTHING_HISTORY_ROOT = "damaged-clothing-history-root"
